...
Continue:
        ...
        'Range("B1").AutoFilter Field:=2, Criteria1:="0.300 cm"
        ...
        Worksheets("Sorted").Select
        'Range("B1").AutoFilter Field:=2, Criteria1:="1.600 cm"
        ...
        ElseIf objDict_3.Count = 1 Then
            materialMessage = materialMessage & vbNewLine & material_3
        ElseIf objDict_3.Count > 1 Then
        ...
        ElseIf objDict_16.Count = 1 Then
            materialMessage = materialMessage & vbNewLine & material_16
        ElseIf objDict_16.Count > 1 Then
