...
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} Set_Formula_Form1 
   ...
   ClientTop       =   456
   ClientWidth     =   12216
   OleObjectBlob   =   "Set_Formula_Form_v1.2.frx":0000
...
Sub SetFormolaAssembly()
    ...
    userParams.Item("height" + "_" + shortUnitName).Value = userParams.Item("height" + "_" + shortUnitName).Value + 1
    userParams.Item("height" + "_" + shortUnitName).Value = userParams.Item("height" + "_" + shortUnitName).Value - 1
...
Sub SetFormolaAssemblyMaster()
    ...
    If OptionButton10.Value = True Then
        ...
        Set iPropertySubject = oDoc.ComponentDefinitionn.Document.PropertySets
        Label26.Caption = iPropertySubject.Item(3).Item(2).Value
