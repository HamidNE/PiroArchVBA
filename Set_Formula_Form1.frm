...
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} Set_Formula_Form1 
   ...
   ClientTop       =   456
   ClientWidth     =   12900
   OleObjectBlob   =   "Set_Formula_Form1.frx":0000
...
Private Sub ComboBoxAssembly_Change()
    ...
    Else
        ...
        For Each param In userParams
            ...
            unitParametersArray(counter) = param.Name
            counter = counter + 1
...
Sub ResizePages()
    ...
    ElseIf MultiPage1.Value = 1 Then    '''Assembly Page
        ...
        MultiPage1.Height = 472
        MultiPage1.Width = 342
        lisPram.Left = 354
        lisPram.Height = 420
        lbLisPram.Left = 372
        Set_Formula_Form1.Width = 502
        Set_Formula_Form1.Height = 510
